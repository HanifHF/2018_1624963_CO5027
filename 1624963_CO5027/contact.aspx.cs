...
namespace _1624963_CO5027
{
    public partial class contact : System.Web.UI.Page
    {
        ...
        {
            //Send email using a mail server client that requires login credentials abd a secure connection

            //Create  mail client and message with to and from address, and set message subject and body

            SmtpClient smtpClient = new SmtpClient();
            MailMessage msg = new MailMessage("hfkiddo@gmail.com", "hfkiddo@gmsil.com");
